...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.codepath.apps.restclienttemplate.models.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.codepath.apps.restclienttemplate.models.GlideOptions().apply(toSet));
    }
  }
}
